	...
	client.on('message-new', async (mek) => {
		try {
			...
			switch(command) {
				...
				case 'sticker':
					...
					break
				case 'gtts':
					if (args.length < 1) return client.sendMessage(from, 'vc inscreveu errado é assim ó ".gtts pt"', text, {quoted: mek})
        ...
        case 'promote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Esse cara aqui @${mentioned[0].split('@')[0]} acabou de se tornar adm, entao respeitem 😎👍`, mentioned, true)
				...
				case 'demote':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Esse cara aqui @${mentioned[0].split('@')[0]} acabou de perder adm pq não merece o cargo 😂!`, mentioned, true)
				...
				case 'kick':
					...
					if (mentioned.length > 1) {
						...
						mentions(`Esse(a) fdp acabou de tomar ban com sucesso 🤣👋 @${mentioned[0].split('@')[0]}`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
				case 'listadmins':
				...
				case 'clone':
					...
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('add alguém para testar')
